...
```
From the distibution of celltype counts (N=16227), over 60% of the cells are identified as oligodendrocytes or oligodendrocyte precursor cells ("31 OPC-Oligo"), with the 2nd and 3rd largest clusters consisting of glutamatergic neuron cells ("23 P Glut") and astrocytes or ependymal cells ("30 Astro-Epen"), respectively.
```
